...
- Offline mode (`BEACON_SCF_OFFLINE=1`) ships **IAC-01**, **CRY-05**, and the **QTS-*** Quantum Security family from SCF 2026.2. It does not vendor the 1534-control workbook.
