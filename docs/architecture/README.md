...
- [ao-rules-and-jev-adapter.md](ao-rules-and-jev-adapter.md) — per-objective rules, the ordered gate, and the Foreman-shaped Jev adapter. Jev scores. Python decides.
