...
- Offline catalog pin: `beacon/scf/catalog/` (SCF **2026.2** summary, families, index-meta, workbook SHA-256). Collector: `scf.catalog.offline`. See [SCF_CATALOG.md](SCF_CATALOG.md).
